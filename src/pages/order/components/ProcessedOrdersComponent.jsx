...
import { get_all_processed_products, update_order_status } from "../../../store/slices/processedProductsSlice";
import ImageCarousal from '../../../components/ImageCarousal'
import { ORDERSTATUS } from '../../../common/constants'
import Pagination from '../../../components/Pagination'
import { filterItems } from '../../../common/constants'

function ProcessedOrdersComponent() {
    const dispatch = useDispatch();
    let orders = useSelector((state) => state.processed.processed);
    ...
    const fetchOrdersData = async (pageNo, filterInfo) => {
        dispatch(get_all_processed_products({ pageNo, filterInfo }));
    };
    ...
    return (
        <div className='relative w-full flex flex-col'>
            ...
            <div className="mt-2 w-full grid grid-cols-1 md:grid-cols-2 gap-16">
                {
...
export default ProcessedOrdersComponent