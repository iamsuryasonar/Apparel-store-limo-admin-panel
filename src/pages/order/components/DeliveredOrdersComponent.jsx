...
import { get_all_delivered_products, update_order_status } from "../../../store/slices/deliveredProductsSlice";
...
function DeliveredOrdersComponent() {
    ...
    const orders = useSelector((state) => state.delivered.delivered);
